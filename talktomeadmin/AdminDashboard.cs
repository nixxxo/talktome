...
namespace talktomeadmin
{
    public partial class AdminDashboard : Form
    {
        ...
        private async void btnEditAdmin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                await _userService.EditUser(selectedUserId, username, email, Path.GetExtension(imagePath), string.IsNullOrWhiteSpace(password) ? null : password, DateTime.Now, "Admin", null, null, (int)selectedPermission);
                _adminImage = null;
